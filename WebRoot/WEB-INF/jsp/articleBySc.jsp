        ...
        <div class="col-sm-9">
           ...
           <ul class="pager">
	            <c:if test="${page.pageNo >1}">
	                <div class="col-sm-6"><li><a  href="${pageContext.request.contextPath}/articleBySc?id=${sys_category_id}&pageNo=${page.pageNo-1}">&larr;上一页</a></li></div>
	            </c:if>
	            <c:if test="${page.pageNo <(totalPage/page.pageSize)}">
	                <div class="col-sm-6"><li><a href="${pageContext.request.contextPath}/articleBySc?id=${sys_category_id}&pageNo=${page.pageNo+1}">下一页 &rarr;</a></li></div>
	            </c:if>
           </ul>
